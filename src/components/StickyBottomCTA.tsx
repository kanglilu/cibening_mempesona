  ...
  return (
    ...
    >
      ...
      <a
        ...
        className="flex-1 bg-[#1F7A4D] hover:bg-[#165a38] text-white h-full px-3 text-xs md:text-sm font-bold flex items-center justify-center gap-1.5 active:scale-[0.98] transition-all pointer-events-auto"
      ...
      <a
        href="#aspirasi"
        className="flex-1 bg-[#0F4C81] hover:bg-[#0F4C81]/90 text-white h-full px-3 text-xs md:text-sm font-bold flex items-center justify-center gap-1.5 active:scale-[0.98] transition-all pointer-events-auto"
        style={{ borderRadius: "8px" }}
      >
